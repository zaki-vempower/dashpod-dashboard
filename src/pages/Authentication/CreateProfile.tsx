...
import SvgIcon from '../../images/icon/phone.svg'
import { accountId } from "../../util.js";
...
export default function CreateProfile() {
  ...
  const registerProfile = async (variableData: any) => {
  ...
  const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    console.log('sdsdssdd',getObj,user)
    registerProfile(getObj);
  };
      ...
      <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        <div className="flex flex-wrap items-center">
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <h2 className="mb-9 text-2xl font-bold text-black dark:text-[#000] sm:text-title-xl2">
                Sign Up to Dashpod
              </h2> */}
        ...
        <div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
          <ul role="list" className="">
            <li
              className="gap-x-6 py-5 bg-orange-700 text-center cursor-pointer border rounded-md "
              onClick={handleCategoryClick}
              data-id="individual"
            >
              <p className="text-sm font-semibold leading-6 text-[#000]">
                {"Individual"}
              </p>
            </li>
            <li
              className="gap-x-6 my-2 py-5 cursor-pointer bg-orange-700 text-center border rounded-md"
              onClick={handleCategoryClick}
            >
              <p className="text-sm font-semibold leading-6 text-[#000]">
                {"Trainer"}
