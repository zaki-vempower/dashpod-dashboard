                  ...
                  <div className="mb-5.5 flex flex-col gap-5.5 sm:flex-row">
                    <div className="w-full sm:w-1/2">
                      ...
                      <div className="relative">
                        ...
                        >
                          {profileUser ? profileUser?.firstName + ' ' + profileUser.lastName : 'David John'}
                    ...
                    <div className="w-full sm:w-1/2">
                      ...
                      <p
                        ...
                        >
                        {profileUser ? profileUser?.mobileNumber : '+91 3343 78656'}
...
{profileUser ? profileUser.emailId : "devidjond45@gmail.com"}
                  ...
                  <div className="mb-5.5">
                    ...
                    {/* <input
                      ...
                      defaultValue=
                    /> */}
                    <p id="Username" className='w-full rounded border border-stroke bg-gray py-3 px-4.5 text-black focus:border-primary focus-visible:outline-none dark:border-strokedark dark:bg-meta-4 dark:text-white dark:focus:border-primary'>
                    {profileUser ? profileUser.firstName : "devidjhon24"}
                    </p>
                  </div>
